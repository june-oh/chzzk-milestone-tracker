  ...
  try {
    ...
    for (const fallback of FALLBACK_STREAMERS) {
      ...
      const history: any = (await kv.get(`streamer:${cid}:history`)) || [
        { date: "2026-05-18", hours: fallback.totalLiveHours - 4 },
        { date: "2026-05-19", hours: fallback.totalLiveHours - 2 },
        { date: "2026-05-20", hours: fallback.totalLiveHours }
      ];
